...
> **What is this file?**
> Project context for coding agents, in the agent-neutral `AGENTS.md` convention:
> architecture, patterns and conventions an agent needs before changing anything
> here. `CLAUDE.md` is a one-line import of this file, so [Claude
> Code](https://claude.ai/code) picks it up automatically; other agents read it
> directly.

## For Contributors

**This project was built by Kristijan Lukacin with Claude AI assistance.** We encourage contributors to use an AI coding agent for development:

1. Install [Claude Code](https://claude.ai/code) CLI, or the agent you prefer
2. Navigate to the project directory
3. Run `claude` to start an AI-assisted session
4. The agent reads this file for context — Claude Code through `CLAUDE.md`
